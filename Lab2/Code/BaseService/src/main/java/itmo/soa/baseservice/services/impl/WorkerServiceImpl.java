...
import itmo.soa.baseservice.exception.NoSuchWorkerException;
import itmo.soa.baseservice.exception.ParamNotFound;
import itmo.soa.baseservice.repositories.CoordinatesRepository;
import itmo.soa.baseservice.repositories.OrganizationRepository;
import itmo.soa.baseservice.repositories.WorkerRepository;
import itmo.soa.baseservice.services.WorkerService;
...
public class WorkerServiceImpl implements WorkerService {
    ...
    public Optional<List<WorkerDTO>> getAllWorkers(Map<String, String> params) {
        ...
        if (params.isEmpty()) return Optional.of(workerRepository.findAll().stream()
    ...
    public Optional<WorkerDTO> updateWorker(UPDWorkerParam dto) {
        ...
        if (dto.getId() != null) {
            ...
            if (workerWrapper.isPresent()){
                ...
                if (dto.getSalary() != null ) worker.setSalary(Double.valueOf(dto.getSalary()));
                if (dto.getStartDate() != null ) worker.setStartDate(LocalDate.parse(dto.getStartDate()));
                if (dto.getStatus() != null ) worker.setStatus(Status.valueOf(dto.getStatus()));
                if (dto.getPosition() != null ) worker.setPosition(Position.valueOf(dto.getPosition()));
    ...
    @Override
    public Optional<String> deleteWorker(String id) {
        try {
